...
<ParamField body="beneficiary.data.phoneNumber" type="string">
  The mobile money number where funds are to be deposited.
</ParamField>
...
curl --location --request POST 'https://api.xente.co/api/transactions/payouts/mobilemoney' \
...
--data-raw '{
  ...
  "message": "Testing",
  "product": {
    "productItemId": "MTNMOBILEMONEYPAYOUTUG_MTNMOBILEMONEYPAYOUTUG"
  },
  "beneficiary": {
    "name": "Tester",
    ...
    "data": {
      "phoneNumber": "0779705600" //The mobile money number where funds are to be deposited
    }
  }
}'
