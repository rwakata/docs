...
{
  "requestId": "{{$guid}}" //Id from your system to uniquely identify the transaction,
  "batchId": "{{$guid}}",
  "amount": 500,
  "type": "DEBIT",
  "message": "Testing",
  "product": {
    "productItemId": "MTNMOBILEMONEYPAYOUTUG_MTNMOBILEMONEYPAYOUTUG" // Use MTNMOBILEMONEYPAYOUTUG_MTNMOBILEMONEYPAYOUTUG MTN Mobile Money Payouts and AIRTELMOBILEMONEYPAYOUTUG_AIRTELMOBILEMONEYPAYOUTUG for Airtel Money Payouts
  },
  "beneficiary": {
    "name": "Tester",
    "emailAddress": "sampleemail@email.com",
    "phoneNumber": "0779705600",
    "data": {
      "phoneNumber": "0779705600" //The mobile money number to deposit or remove funds from
    }
  }
}
