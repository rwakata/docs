---
title: "Post bill pay"
api: "POST https://dev.xente.co:7027/api/billpay/transactions"
...
```json
{
  ...
  "amount": 100.5,
  "type": "DEBIT", //DEBIT to add money to your account, CREDIT to remove money from your account
  ...
  "beneficiary": {
    ...
    "data": {
      "phoneNumber": "+1234567890",
      "billerName": "ELECTRICITYCO",
      "billerAccountNumber": "123234234",
