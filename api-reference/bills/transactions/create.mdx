---
title: "Post bill pay"
api: "POST https://api.xente.co/api/transactions/payouts/utilities"
description: "This endpoint posts a new bill pay transaction"
---
...
<ParamField body="beneficiary.data.customerReference" type="string">
  Your Electricity/National Water Account Number.
</ParamField>

<ParamField body="beneficiary.data.area" type="string">
  Area is required for National water bill payments but optional for Electricity
</ParamField>
...
curl --location --request POST 'https://api.xente.co/api/transactions/payouts/utilities' \
...
--data-raw '{
  ...
  "product": {
    "id": "NWSCWATERUG",
    "productItemId": "NWSCWATERUG_NWSCWATERUG" 
  },
  "beneficiary": {
    "name": "John Doe",
    ...
    "data": {
      "customerReference": "4637738888" //Your Electricity/National Water Account Number,
      "area": "Kampala" //Area is required for National water bill payments but optional for Electricity
    }
  }
}'
