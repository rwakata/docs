---
title: "Post bank transfer"
api: "POST https://dev.xente.co:7027/api/banktransfers/transactions"
description: "This endpoint posts a new mobile money transaction"
---
...
<ParamField body="beneficiary.data.bankAccount" type="string">
  The bank account number of the beneficiary
</ParamField>
<ParamField body="beneficiary.data.bankCode" type="string">
  The bank account code of the bank
</ParamField>
...
```bash Example Request
{
  ...
  "beneficiary": {
    ...
    "data": {
      ...
      "bankName": "Bank Code" //The Code of the bank funds are being sent to
    }
  }
}
```
